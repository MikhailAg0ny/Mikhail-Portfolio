        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1.2fr] lg:items-center">
          <div className="flex justify-center lg:justify-start">
            <div className="relative">
              <div className="h-56 w-56 overflow-hidden rounded-full border-4 border-victus-blue shadow-2xl shadow-victus-blue/20 sm:h-72 sm:w-72 lg:h-80 lg:w-80">
                <ImageWithFallback
          ...
          <div className="space-y-6 text-center lg:max-w-xl lg:text-left">
            ...
            <Tooltip.Provider delayDuration={200} skipDelayDuration={400}>
              <div className="flex flex-col gap-4 sm:flex-row sm:justify-center lg:justify-start lg:gap-5">
                <Tooltip.Root>
